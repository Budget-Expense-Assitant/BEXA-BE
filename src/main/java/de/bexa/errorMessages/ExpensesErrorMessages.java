...
public class ExpensesErrorMessages {
    public static final String EXPENSE_AMOUNT_NOT_GIVEN = "Höhe der Ausgabe nicht gegeben!";
    public static final String EXPENSE_DATE_NOT_GIVEN = "Eingangsdatum der Ausgabe nicht gegeben!";
