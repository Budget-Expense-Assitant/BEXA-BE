...
public class IncomeErrorMessages {
    public static final String INCOME_AMOUNT_NOT_GIVEN = "Höhe der Einnahme nicht gegeben!";
    public static final String INCOME_DATE_NOT_GIVEN = "Eingangsdatum der Einnahme nicht gegeben!";
